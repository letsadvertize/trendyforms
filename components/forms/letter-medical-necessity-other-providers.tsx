...
export function LetterMedicalNecessityOtherProviders() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        formType: "letter-medical-necessity-other-providers",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-600 mb-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="customProviderName" className="text-sm font-semibold text-green-700">
                      Provider Name
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderEmail" className="text-sm font-semibold text-green-700">
                      Provider Email
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderPhone" className="text-sm font-semibold text-green-700">
                      Provider Phone
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderAddress" className="text-sm font-semibold text-green-700">
                      Provider Address
                    </Label>
                    <Input
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  ...
                  <Button
                    ...
                    className="mt-3 bg-green-50 hover:bg-green-100"
                  >
                    <Plus className="h-4 w-4 mr-2" />
                    Add Family History
                  </Button>
