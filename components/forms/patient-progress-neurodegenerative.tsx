...
export function PatientProgressNeurodegenerative() {
          ...
          <Card className="max-w-2xl mx-auto shadow-xl text-center">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 mb-6">
                The Progress Note for Neurodegenerative Patient has been saved to Google Drive and will be processed shortly.
              </p>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-purple-200 text-sm">Neurodegenerative Patient</p>
            </div>
          </div>
