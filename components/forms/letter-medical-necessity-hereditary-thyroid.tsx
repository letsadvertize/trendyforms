...
// ...existing code...
export function LetterMedicalNecessityHereditaryThyroid() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        formType: "letter-medical-necessity-hereditary-thyroid",
        ...
        <Card className="max-w-4xl mx-auto bg-white shadow-xl">
          ...
          <CardContent className="p-8 space-y-8">
            <form onSubmit={handleSubmit}>
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-600 mb-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="customProviderName" className="text-sm font-semibold text-yellow-700">
                      Provider Name
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderEmail" className="text-sm font-semibold text-yellow-700">
                      Provider Email
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderPhone" className="text-sm font-semibold text-yellow-700">
                      Provider Phone
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderAddress" className="text-sm font-semibold text-yellow-700">
                      Provider Address
                    </Label>
                    <Input
              ...
              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <div className="space-y-4">
                  ...
                  <p className="text-slate-800 leading-relaxed">
                    ...
                    to document the medical necessity of genetic testing.
                  </p>
                  <p className="text-slate-800 leading-relaxed">
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  ...
                  <Button
                    ...
                    className="mt-3 bg-yellow-50 hover:bg-yellow-100"
                  >
                    <Plus className="h-4 w-4 mr-2" />
                    Add Family History
                  </Button>
                ...
                <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                  <div className="space-y-4 text-slate-800 leading-relaxed">
                    ...
                    <p>
                      ...
                      diagnosis of a hereditary condition and thereby helping to clarify the patient's risk
              ...
              {/* Submit Button */}
              <div className="flex justify-center pt-6 border-t border-yellow-200">
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="bg-yellow-600 hover:bg-yellow-700 text-white px-8 py-3 text-lg font-semibold shadow-lg"
                >
