...
export function ProgressNoteHereditaryThyroid() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        formType: "progress-note-hereditary-thyroid",
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-600 mb-6">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="providerPhone" className="text-sm font-semibold text-yellow-700">
                      Provider Phone
                    </Label>
                    <Input
                      id="providerPhone"
