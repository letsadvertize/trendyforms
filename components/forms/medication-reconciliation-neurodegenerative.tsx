...
export function MedicationReconciliationNeurodegenerative() {
      ...
      <div className="container mx-auto px-4">
        ...
        <Card className="max-w-4xl mx-auto bg-white shadow-xl">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-purple-100 text-sm">Neurodegenerative Specialty</p>
                </div>
              </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-600 mb-8">
              <div className="flex justify-between items-center text-sm">
                <div>
                  <p className="font-semibold text-purple-800">Hospital in Your Home</p>
                  <p className="text-purple-600">Comprehensive Healthcare Solutions</p>
                </div>
