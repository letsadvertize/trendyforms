...
export function ProgressNoteDiabetesModyPredict() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        formType: "progress-note-diabetes-mody-predict",
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-pink-50 p-4 rounded-lg border-l-4 border-pink-600 mb-6">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label htmlFor="providerPhone" className="text-sm font-semibold text-pink-700">
                      Provider Phone
                    </Label>
                    <Input
                      id="providerPhone"
