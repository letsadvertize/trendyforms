...
// Use 'general' as fallback since 'cardiopulmonary-testing' is not in appTheme.specialties
const specialty = "general"
const theme = getSpecialtyTheme(specialty)
// This is a copy of the Other Providers form, you can customize fields for Cardiopulmonary Testing as needed
export function LetterMedicalNecessityCardiopulmonaryTesting() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        formType: "letter-medical-necessity-cardiopulmonary-testing",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-600 mb-6">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="customProviderName" className="text-sm font-semibold text-blue-700">
                      Provider Name
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderEmail" className="text-sm font-semibold text-blue-700">
                      Provider Email
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderPhone" className="text-sm font-semibold text-blue-700">
                      Provider Phone
                    </Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="customProviderAddress" className="text-sm font-semibold text-blue-700">
                      Provider Address
                    </Label>
                    <Input
              ...
              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <div className="space-y-4">
                  ...
                  <p className="text-slate-800 leading-relaxed">
                    ...
                    to document the medical necessity of cardiopulmonary testing.
                  </p>
                  <p className="text-slate-800 leading-relaxed">
                    I have determined that this test is medically necessary for the above patient due to the following
                    history, which is strongly indicative of a cardiopulmonary condition
                    <Input
                    ...
                    />
                    consistent with a clinical indication for advanced testing.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  ...
                  <Button
                    ...
                    className="mt-3 bg-blue-50 hover:bg-blue-100"
                  >
                    <Plus className="h-4 w-4 mr-2" />
                    Add Family History
                  </Button>
              ...
              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                <p className="text-slate-800 leading-relaxed">
                  Based on my evaluation and review of the available literature, I believe that the cardiopulmonary testing is warranted and medically necessary for my patient.
                </p>
              </div>
